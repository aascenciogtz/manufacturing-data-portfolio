...
SELECT * FROM vw_ordenes_opex WHERE producto IN ('Carcasa AX');
...
SELECT * FROM paros WHERE comentario NOT LIKE '';
...
SELECT * FROM vw_ordenes_opex ORDER BY costo_operacion_usd DESC LIMIT 5;
...
SELECT * FROM vw_ordenes_opex WHERE turno = 'A' AND estado = 'Completada';

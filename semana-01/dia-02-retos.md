...
Respuesta basada en los resultados: SELECT * FROM vw_ordenes_opex WHERE turno = 'A' AND estado = 'Completada';
...
Respuesta basada en los resultados: SELECT * FROM vw_ordenes_opex WHERE producto IN ('Carcasa AX', 'Engrane CX', 'Panel EX') AND fecha BETWEEN '2026-08-10' AND '2026-08-20' ORDER BY costo_operacion_usd ASC;
...
Respuesta basada en los resultados: SELECT * FROM paros WHERE comentario IS NULL AND responsable NOT LIKE 'Calidad';
